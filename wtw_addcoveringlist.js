...
WTWJS.prototype.getCoveringList = function(zshape) {
	...
	try {
		if (zshape == 'terrain') {
			...
			zcoveringlist[zcoveringlist.length] = 'Website'; // Add this line to include the new covering type
		}
	...
	try {
		switch (zcoveringname) {
			...
			case 'hidden':
				...
				WTW.hide('wtw_moldbasictextureset2div');
				break;
			case 'website': // Add this case for the new covering type
				WTW.hide('wtw_moldcolorsdiv');
				WTW.hide('wtw_moldtexturetitle');
				WTW.hide('wtw_moldbumptexturetitle');
				WTW.hide('wtw_moldbumptextureset2div');
				WTW.hide('wtw_moldtexturepreview');
				WTW.hide('wtw_moldbasictextureset2div');
				// Add the following line to show the website link input field
				WTW.show('wtw_moldwebsitelinkdiv');
				break;
			case 'color':
				WTW.show('wtw_moldcolorsdiv');
				WTW.hide('wtw_moldtexturetitle');
